...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **538 commits over 199 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 1026 | 5.2 |
| injected controls | 124 | 0.6 |
| bit-exact verifiers | 8 | — |
| lines of RTL | 9,269 | 47 |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 329.32s (0:05:29) |
