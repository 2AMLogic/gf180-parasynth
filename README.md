...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **541 commits over 200 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 1045 | 5.2 |
| injected controls | 133 | 0.7 |
| bit-exact verifiers | 8 | — |
| lines of RTL | 9,269 | 46 |
...
| `F3` | Measurement ground truth | **GREEN** | 135 passed in 3.12s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 408.80s (0:06:48) |
