...
<!-- BOARD:BEGIN -->
**21 of 100 acceptance cases have a valid measurement.** 6 pass · 15 fail · 4 no verdict · 75 not run.
...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **365 commits over 145 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 788 | 5.4 |
| injected controls | 90 | 0.6 |
| bit-exact verifiers | 7 | — |
| lines of RTL | 9,181 | 63 |
...
| `F3` | Measurement ground truth | **GREEN** | 134 passed in 3.16s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 401.22s (0:06:41) |
