...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **574 commits over 205 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 1127 | 5.5 |
| injected controls | 133 | 0.6 |
| bit-exact verifiers | 8 | — |
| lines of RTL | 9,386 | 46 |
...
| `F3` | Measurement ground truth | **GREEN** | 135 passed in 1.39s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 172.31s (0:02:52) |
