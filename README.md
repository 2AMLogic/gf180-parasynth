...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **592 commits over 209 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 1244 | 6.0 |
| injected controls | 148 | 0.7 |
...
| `F3` | Measurement ground truth | **GREEN** | 135 passed in 1.44s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 179.55s (0:02:59) |
