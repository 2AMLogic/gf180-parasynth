...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **578 commits over 206 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 1187 | 5.8 |
| injected controls | 141 | 0.7 |
...
| `F3` | Measurement ground truth | **GREEN** | 135 passed in 1.52s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 182.72s (0:03:02) |
