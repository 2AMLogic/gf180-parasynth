...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **469 commits over 188 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 874 | 4.7 |
| injected controls | 95 | 0.5 |
...
| `F3` | Measurement ground truth | **GREEN** | 134 passed in 2.99s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 402.76s (0:06:42) |
