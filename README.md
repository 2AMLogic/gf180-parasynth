...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **476 commits over 190 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 904 | 4.8 |
| injected controls | 97 | 0.5 |
| bit-exact verifiers | 7 | — |
| lines of RTL | 9,181 | 48 |
...
| `F3` | Measurement ground truth | **GREEN** | 134 passed in 1.93s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 211.33s (0:03:31) |
