...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **283 commits over 97 hours.**

| | now | per hour |
|---|---:|---:|
| tests | 764 | 7.8 |
| injected controls | 90 | 0.9 |
| bit-exact verifiers | 7 | — |
| lines of RTL | 5,788 | 59 |
...
| `F3` | Measurement ground truth | **GREEN** | 134 passed in 2.72s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 291.94s (0:04:51) |
