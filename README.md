...
<!-- HISTORY:BEGIN -->
Measured from git, not remembered. **235 commits over 94 hours.**
...
| `F3` | Measurement ground truth | **GREEN** | 134 passed in 1.90s |
...
| `D2` | Is an 808, per the reference **fidelity** | **GREEN** | 104 passed in 216.23s (0:03:36) |
