...
foreach c $cells {
    ...
    emit "---- P/PCOUT fanout ----"
    foreach pn {P PCOUT} {
        foreach p [get_pins -quiet -of_objects $cell -filter "REF_PIN_NAME == $pn"] {
