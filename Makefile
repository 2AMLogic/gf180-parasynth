...
verify-fast:
	@$(RUN) --timeout 600 --json build/verification/verify-fast.json \
	  ...
	  "$(PY) -m pytest fpga/test_selected_preset.py fpga/test_build_selected.py fpga/test_build_arty.py fpga/test_publish_arty.py fpga/test_publish_selected.py tools/test_setup_ci_oss_cad.py fpga/test_spi_host.py -q" \
