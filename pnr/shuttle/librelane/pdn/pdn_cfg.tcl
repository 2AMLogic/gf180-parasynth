...
# CHANGE FROM UPSTREAM (see ../../TEMPLATE_PROVENANCE.txt): the template sources
# pdn/pdn_5v_sram.tcl here to build per-macro power grids for its two example SRAMs.
# This design has no macros, so there is nothing to source. Everything above --
# std-cell rails, Metal4/Metal3 straps, the 25 um core ring and its connection to the
# pad ring -- is the template's, unedited.
